...
ActiveRecord::Schema.define(version: 2022_06_09_075317) do

  create_table "books", charset: "utf8mb4", force: :cascade do |t|
    t.string "title"
    t.string "author"
    t.integer "pulication_year"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  end

  create_table "org_companies", charset: "utf8mb4", force: :cascade do |t|
  ...
  create_table "org_people", charset: "utf8mb4", force: :cascade do |t|
